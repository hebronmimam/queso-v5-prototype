(() => {
  ...
  const NAV_GROUPS = [
    { title:"Shop", links:[["Cake types","/cakes"],["Shop by flavor","/flavors"],["Monthly drop","/cakes/flavor-drop"]] },
    { title:"About", links:[["Our story","/our-story"],["Popups","/#popups"],["Connect","/connect"]] },
    { title:"Help", links:[["Contact us","/connect"],["Privacy policy","/privacy-policy"],["Terms","/terms-conditions"]] },
    { title:"Follow", links:[["Instagram @quesohk ↗","https://www.instagram.com/quesohk/"],["hello@quesocakes.com","mailto:hello@quesocakes.com"]] }
  ];

  class QuesoSiteFooter extends HTMLElement {
    static get observedAttributes() {
      return [
        "marquee","pitch-eyebrow","pitch-title","pitch-button-label","pitch-button-url",
        "signup-eyebrow","signup-title","signup-copy","signup-placeholder","signup-button-label",
        "brand-copy","copyright","location-copy"
      ];
    }
    ...
    render() {
      const marquee = this.value("marquee","FRESHLY BAKED ✦ HONG KONG ✦ ONLINE ONLY ✦ POPUPS ✦ FREE TST MTR PICKUP ✦");
      ...
      this.shadowRoot.innerHTML = `
        <style>
          ...
          *,*::before,*::after { box-sizing:border-box; }
          ...
          .footer { min-height:inherit; height:100%; overflow:hidden; background:var(--brown); border-top:2px solid var(--brown); }

          .marquee { overflow:hidden; white-space:nowrap; background:var(--yellow); color:var(--brown); border-bottom:2px solid var(--brown); }
          .marquee-track { display:flex; width:max-content; animation:footer-marquee 28s linear infinite; }
          .marquee-row { padding:11px 0; font-family:"Queso Lovelo",Arial,sans-serif; font-size:12px; line-height:1; letter-spacing:.06em; word-spacing:.4em; }
          ...
          .footer-doodle span { font-family:"Queso Lovelo",Arial,sans-serif; font-size:60px; line-height:.8; }
          .footer-doodle small { margin-top:7px; font-family:"Queso Lovelo",Arial,sans-serif; font-size:8px; line-height:1.15; text-align:center; }
          ...
          .button--yellow { justify-self:end; white-space:nowrap; background:var(--yellow); transform:rotate(-2deg); }
          ...
          .footer-signup p { max-width:600px; margin:12px 0 0; font-size:13px; line-height:1.55; }
          .footer-form { display:flex; align-items:stretch; }
          .footer-form label { position:absolute; left:-9999px; }
          .footer-form input { min-width:0; flex:1; height:54px; padding:0 16px; background:#fff; color:var(--brown); border:2px solid var(--brown); border-right:0; border-radius:0; }
          .footer-form .button { height:54px; border-radius:0; background:var(--orange); color:#fff; }
          .form-status { min-height:20px; margin-top:8px; font-size:11px; font-weight:750; }
          ...
          .footer-brand p { max-width:300px; margin:20px 0 0; color:rgba(253,243,230,.78); font-size:13px; line-height:1.55; }
          .footer-col { display:flex; flex-direction:column; align-items:flex-start; gap:10px; }
          .footer-col strong { margin-bottom:4px; color:var(--pink); font-family:"Queso Lovelo",Arial,sans-serif; font-size:12px; letter-spacing:.05em; text-transform:uppercase; }
          .footer-col a { font-size:13px; line-height:1.45; }
          ...
          .footer-bottom {
            ...
            gap:20px;
            border-top:1px solid rgba(253,243,230,.35);
            color:rgba(253,243,230,.75);
            font-size:11px;
          }

          @media(max-width:980px) {
            :host { min-height:auto; }
            .footer-play { grid-template-columns:1fr auto; }
            .footer-doodle { display:none; }
          ...
          @media(max-width:680px) {
            .marquee-row { font-size:10px; }
            .footer-play { min-height:0; padding:46px 20px; display:block; }
            .footer-pitch h2 { font-size:52px; }
            .button--yellow { margin-top:28px; transform:rotate(-1deg); }
            .footer-signup { padding:44px 20px; }
            .footer-form { flex-direction:column; }
            .footer-form input { border-right:2px solid var(--brown); border-bottom:0; }
            .footer-form .button { width:100%; }
            .footer-top { padding:44px 20px 30px; grid-template-columns:1fr 1fr; gap:34px 25px; }
            .footer-bottom { margin:0 20px; flex-direction:column; }
          }

          @media(prefers-reduced-motion:reduce) { .marquee-track { animation:none; } .button { transition:none; } }
        </style>
        ...
        <footer class="footer">
          ...
          <div class="footer-play">
            ...
            <div class="footer-doodle" aria-hidden="true"><span>Q</span><small>BAKED<br>FRESH</small></div>
